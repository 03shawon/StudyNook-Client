...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // console.log(user, 'from register page')
      ...
      <Card className="bg-[#1a1a2e] border border-gray-800/80 shadow-2xl p-6 md:p-10 rounded-3xl w-full max-w-md text-white">
        ...
        <Form onSubmit={handleSubmit} className="flex w-full flex-col gap-4">
          <TextField isRequired name="name" type="text">
            <Label className="text-gray-300 font-semibold text-xs uppercase tracking-wider mb-1 block">
              Full Name
            </Label>
            <Input
              placeholder="John Doe"
              className="bg-[#0f172a] text-white border-gray-800 rounded-xl py-2 px-3"
            />
            <FieldError />
          </TextField>
        ...
        <div className="flex items-center my-5">
          ...
          <span className="px-3 text-gray-500 text-xs uppercase tracking-wider">
            Or
          </span>
          <div className="flex-grow border-t border-gray-800"></div>
        </div>
